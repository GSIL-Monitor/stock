            ...
            this._l(columnRows, (columns, rowIndex) =>
              <tr>
              {
                this._l(columns, (column, cellIndex) =>
                  <th
                    ...
                    style={ (column.realWidth || column.width) ? 'width:' + (column.realWidth || column.width) + 'px' : '' }
                    ...
                    style={ (column.realWidth || column.width) ? 'width:' + ((column.realWidth || column.width) - 1) + 'px' : '' }
                    >
                    {
                      column.renderHeader
              ...
              }
              {
                !this.fixed && this.layout.scrollY && this.layout.gutterWidth
                  ? <th class="gutter" style={{ width: this.layout.scrollY ? this.layout.gutterWidth + 'px' : '0' }}>
                      <div style={{ width: this.layout.scrollY ? this.layout.gutterWidth + 'px' : '0' }} ></div>
                  </th>
                  : ''
              }
              </tr>
