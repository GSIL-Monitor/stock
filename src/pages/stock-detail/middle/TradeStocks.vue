...
export default {
    ...
    props: {
        ...
        */
        componentType: {
            ...
            default: 'trade',
            validator(val) {
                return ['trade', 'related'].includes(val)
            },
        }
    },
    computed: {
        ...
        isTrade() {
            return Object.is(this.componentType, 'trade')
        },
        isRelated() {
            return Object.is(this.componentType, 'related')
        },
        listTradeApi() {
            if (this.isAStock) {
    ...
    methods: {
        ...
        indexChanged(start, end) {
            pushData(FRAME_TRADE_STOCK, {
                ...
                field: 'name;code;stock_type;close_price;source;symbol_type;price;price_change_rate;price_change;volume;turnover;turnover_rate;amplitude;quantity_ratio;commission_rate;',
    ...
    created() {
        this.fetchData()
        goGoal.event.listen(FRAME_TRADE_STOCK, this.receiveTradeData)
    },
    beforeDestroy() {
        goGoal.event.remove(FRAME_TRADE_STOCK, this.receiveTradeData)
    },
}
</script>
